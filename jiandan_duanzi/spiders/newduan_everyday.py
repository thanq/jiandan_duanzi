...
from jiandan_duanzi.items import New100ZanDuanziItem
...
class NewDuanziSpider(scrapy.Spider):
    ...
    def gen_new_duanzi_item_by_selector(self, dz_selector):
        #作者
        ...
        return New100ZanDuanziItem(content=content, floor=floor, zan=zan)
